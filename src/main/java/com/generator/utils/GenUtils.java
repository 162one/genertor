...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(Map<String, String> column : columns){
			...
			if(column.get("columnType").equalsIgnoreCase("int(11)")){
			...
			if("PRI".equalsIgnoreCase(column.get("columnKey")) && tableEntity.getPk() == null){
				if(columnEntity.getDataType().equalsIgnoreCase("bigint")){
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("Mapper.xml.vm" )) {
			return packagePath + "mapperXml" + File.separator + className + "Mapper.xml";
		}

		if (template.contains("list.html.vm" )) {
			return "main" + File.separator + "resources" + File.separator + "pdfTemplates" + File.separator
